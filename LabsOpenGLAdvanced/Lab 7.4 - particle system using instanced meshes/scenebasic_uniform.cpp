...
SceneBasic_Uniform::SceneBasic_Uniform() :
    ...
    torus(0.7f * 0.1f, 0.3f * 0.1f, 20, 20),  // lab 7.4
    // particleLifeTime(5.5f),      // lab 7.2
    // particleLifeTime(6.0f),  // lab 7.3
    particleLifeTime(10.5f),            // lab 7.4
    // nParticles(8000),            // lab 7.2
    // nParticles(4000),        // lab 7.3
    nParticles(500),                    // lab 7.4
    // emitterPos(1, 0, 0),     // lab 7.3
    emitterPos(0.0f),                   // lab 7.4
    // emitterDir(-1, 2, 0)     // lab 7.3
    emitterDir(0, 1, 0)                 // lab 7.4
{
...
void SceneBasic_Uniform::initScene()
{
    ...
    // prog.use();                                          // disabled in lab 7.4
    // prog.setUniform("ParticleTex", 0);                   // disabled in lab 7.4
    prog.setUniform("ParticleLifetime", particleLifeTime);
    // prog.setUniform("ParticleSize", 0.05f);              // disabled in lab 7.4
    // prog.setUniform("Gravity", vec3(0.0f, -0.2f, 0.0f)); // disabled in lab 7.3
    prog.setUniform("EmitterPos", emitterPos);

    // prog.setUniform("RandomTex", 1); // disabled in lab 7.4
...
void SceneBasic_Uniform::compile()
{
	...
	try {
        ...
        const char* outputNames[] = { "Position", "Velocity", "Age", "Rotation" };  // lab 7.4
        // glTransformFeedbackVaryings( progHandle, 3, outputNames, GL_SEPARATE_ATTRIBS );
        glTransformFeedbackVaryings( progHandle, 4, outputNames, GL_SEPARATE_ATTRIBS ); // lab 7.4
        ///////////////////////////////////////////////////////
...
void SceneBasic_Uniform::initBuffers()
{
    ...
    int size = nParticles * sizeof(GLfloat); // lab 7.4
    ...
    */
    ...
    std::vector<GLfloat> tempData(nParticles);  // former data from above, it is called initialAges in lab 7.4
    ...
    glBindBuffer(GL_ARRAY_BUFFER, age[0]);
    glBufferSubData(GL_ARRAY_BUFFER, 0, nParticles * sizeof(float), tempData.data());   // it is called initialAges in lab 7.4
    ...
    /* former set up particle array 0
    ...
    */
    ...
    /* former set up particle array 1
    ...
    */
    ...
    glBindBufferBase(GL_TRANSFORM_FEEDBACK_BUFFER, 3, rotation[0]); // lab 7.4
    ...
    glBindBufferBase(GL_TRANSFORM_FEEDBACK_BUFFER, 3, rotation[1]); // lab 7.4
...
void SceneBasic_Uniform::render()
{
    ...
    // prog.setUniform("Material.Kd", 0.2f, 0.5f, 0.9f);    // color of blue
    prog.setUniform("Material.Kd", 0.8f, 0.5f, 0.2f);
