...
private:
    ...
    // GLuint initVel, startTime, particles, nParticles;    // available only for lab 7.2, replaced in lab 7.3

    // Particle buffers
    GLuint posBuf[2], velBuf[2], age[2];

    GLuint rotation[2]; // added in lab 7.4
    ...
    int nParticles;         // added in lab 7.3
    float particleLifeTime;
    float deltaT;           // added in lab 7.3
