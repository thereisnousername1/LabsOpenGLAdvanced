...
SceneBasic_Uniform::SceneBasic_Uniform() :
    ...
    // particleLifeTime(3.0f),  // lab 7.5
    particleLifeTime(10.0f),     // lab 7.5b
    // nParticles(8000),
    // nParticles(4000),    // lab 7.3
    nParticles(1000),       // lab 7.5b
    // emitterPos(1, 0, 0),     // lab 7.3
    emitterPos(0, 0, 0),        // lab 7.5
    // emitterDir(-1, 2, 0) // lab 7.3
    emitterDir(0, 1, 0)    // lab 7.5
{
...
void SceneBasic_Uniform::initScene()
{
    ...
    // glClearColor(0.1f, 0.1f, 0.1f, 1.0f);    // set up a background color, lab 7.3
    glClearColor(1.0f, 1.0f, 1.0f, 1.0f);       // set up a background color, lab 7.5
    ...
    // prog.setUniform("ParticleSize", 0.05f);  // lab 7.3
    // prog.setUniform("ParticleSize", 0.5f);   // lab 7.5a, disabled in lab 7.5b
    ...
    // prog.setUniform("Accel", vec3(0.0f, -0.5f, 0.0f));   // lab 7.3
    prog.setUniform("Accel", vec3(0.0f, 0.1f, 0.0f));       // lab 7.5
...
void SceneBasic_Uniform::initBuffers()
{
    ...
    */
    ...
    Random::shuffle(tempData);  // lab 7.5, to add a bit of unpredictability for a more realistic fire
