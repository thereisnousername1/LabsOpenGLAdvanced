...
public:
    int width;
    int height;
    float sigma2 = 25.0f;   // declared as global for instant gauss calculate, was 8.0f in lab 5.2
                            // declared in scene.h so that scenerunner can modify it

    float Gamma = 0.8f;     // refer to lab sheet 5 p.43, it has no further description to the gamma correction at all
