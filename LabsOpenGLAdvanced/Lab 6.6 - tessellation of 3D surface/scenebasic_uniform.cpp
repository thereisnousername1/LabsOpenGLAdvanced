...
void SceneBasic_Uniform::initScene()
{
    ...
    */
    ...
    // prog.setUniform("Inner", 4);                                     // disabled in lab 6.6
    // prog.setUniform("Outer", 4);                                     // disabled in lab 6.6
    prog.setUniform("TessLevel", 4);

    prog.setUniform("LineWidth", 1.5f);
    prog.setUniform("LineColor", vec4(0.05f, 0.0f, 0.05f, 1.0f));
    // prog.setUniform("QuadColor", vec4(1.0f, 1.0f, 1.0f, 1.0f));      // disabled in lab 6.6

    // prog.setUniform("Line.Color", vec4(0.05f, 0.0f, 0.05f, 1.0f));   // disabled in lab 6.6
